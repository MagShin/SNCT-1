...
// edit user
if(@$_GET['q']== 'edituser' && $_SESSION['key']=='sunny7785068889') {
$demail=@$_GET['demail'];
$result = mysqli_query($con,"SELECT * FROM user WHERE email='$demail' ") or die('Error');
...
<tr><td>Name</td><td><input type="text" class="form-control" value="'.$name.'" required></td></tr>
<tr><td>Mobile</td><td><input type="text" class="form-control" value="'.$mobile.'" required></td></tr>
<tr><td>Gender</td><td><input type="text" class="form-control" value="'.$gender.'" required></td></tr>
<tr><td>Address</td><td><input type="text" class="form-control" value="'.$address.'" required></td></tr>
<tr><td>College</td><td><input type="text" class="form-control" value="'.$college.'" required></td></tr>
<tr><td></td><td><a href="update.php?demail='.$demail.'&q=updateuser" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp;Update</a></td></tr>
</table></div></div>';
